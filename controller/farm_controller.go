...
func FarmToControlPanel(cp *ControlPanel, farm *social.Farm) {
	...
	fp.AddButton(LandUseButton{
		b:       gui.ButtonGUI{Icon: "artifacts/grain", X: float64(50), Y: hcy, SX: IconS, SY: IconS},
		luc:     fc,
		useType: economy.FarmFieldUseTypeWheat,
	})
	fp.AddButton(LandUseButton{
		b:       gui.ButtonGUI{Icon: "artifacts/vegetable", X: float64(90), Y: hcy, SX: IconS, SY: IconS},
		luc:     fc,
		useType: economy.FarmFieldUseTypeVegetables,
	})
	fp.AddButton(LandUseButton{
		b:       gui.ButtonGUI{Icon: "artifacts/fruit", X: float64(130), Y: hcy, SX: IconS, SY: IconS},
		luc:     fc,
		useType: economy.FarmFieldUseTypeOrchard,
	})
	fp.AddButton(LandUseButton{
		b:       gui.ButtonGUI{Icon: "artifacts/sheep", X: float64(10), Y: hcy + 40, SX: IconS, SY: IconS},
		luc:     fc,
		useType: economy.FarmFieldUseTypePasture,
	})
	fp.AddButton(LandUseButton{
		b:       gui.ButtonGUI{Icon: "artifacts/log", X: float64(50), Y: hcy + 40, SX: IconS, SY: IconS},
		luc:     fc,
		useType: economy.FarmFieldUseTypeForestry,
	})
	fp.AddButton(LandUseButton{
		b:       gui.ButtonGUI{Icon: "artifacts/reed", X: float64(90), Y: hcy + 40, SX: IconS, SY: IconS},
		luc:     fc,
		useType: economy.FarmFieldUseTypeReed,
	})
	fp.AddButton(LandUseButton{
		b:       gui.ButtonGUI{Icon: "artifacts/herb", X: float64(130), Y: hcy + 40, SX: IconS, SY: IconS},
		luc:     fc,
