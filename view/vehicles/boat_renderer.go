...
func DrawBoat(cv *canvas.Canvas, t *navigation.Traveller, x float64, y float64, c *controller.Controller) (float64, float64, float64, float64, float64) {
	if !t.Visible {
		return 0, 0, 0, 0, 0
	}
	dirIdx := (c.Perspective - t.Direction) % 4
